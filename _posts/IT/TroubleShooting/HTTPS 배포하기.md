...
**시작 전 주의사항: HTTP 배포를 버지니아 북부 region으로 설정하고 생성했는지 다시 확인**        
  ->  인증서 발급 받으려면 반드시 필요        
[인증서 발급시 주의사항](https://repost.aws/ko/knowledge-center/migrate-ssl-cert-us-east)    
...
[도메인 연결 HTTP 적용 블로그 참고](https://un-lazy-midnight.tistory.com/172#%EB%8F%84%EB%A9%94%EC%9D%B8%EA%B3%BC%20EC2%20%EC%97%B0%EA%B2%B0-1)        
...
[EC2 HTTPS 및 로드밸런서 적용 참고](https://jindevelopetravel0919.tistory.com/192)       
